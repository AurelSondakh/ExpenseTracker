...
import { getCategoryBreakdown } from '../../Data/StatsService';
...
const UserStats = () => {
  ...
  useEffect(() => {
    async function fetchUserStats() {
      ...
      const breakdown = await getCategoryBreakdown(decoded?.username, startDate.toISOString().split('T')[0], endDate.toISOString().split('T')[0]);
